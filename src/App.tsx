  ...
  return (
    <Box bgcolor={colors.primaryBlack} sx={{ minHeight: "100vh", margin: 0 }}>
      ...
      >
        ...
        <Stack p={isTablet ? 3 : 4}>
          <Typography color={colors.white} sx={{ mt: 10 }}>
            ...
            bytes lists Start with 'Lorem ipsum dolor sit amet...' What is Lorem
            ...
            dolor sit amet...' What is Lorem Ipsum? Lorem Ipsum is simply dummy
